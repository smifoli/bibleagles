    ...
    <div className="flex flex-col gap-2 rounded-[10px] border border-input-border bg-background p-2.5">
      <div className="flex items-center gap-2">
        <select
          ...
          className="flex-1 rounded-[8px] border border-input-border bg-surface px-2 py-1.5 text-[calc(12px*var(--font-scale))] text-ink"
        >
        ...
        {onRemove && (
          <button type="button" onClick={onRemove} className="text-[calc(11px*var(--font-scale))] font-semibold text-text-muted">
            Remover
          </button>
        )}
      </div>
...
function NumberField({
  ...
  return (
    <label className="flex flex-col gap-0.5">
      <span className="text-[calc(8px*var(--font-scale))] font-semibold uppercase tracking-[1px] text-text-muted">{label}</span>
      <input
        type="number"
        min={1}
        required={required}
        ...
        className="rounded-[8px] border border-input-border bg-surface px-1.5 py-1 text-[calc(12px*var(--font-scale))] text-ink"
      />
    </label>
  );
}
