...
export const AutoResizeTextarea = forwardRef<HTMLTextAreaElement, AutoResizeTextareaProps>(function AutoResizeTextarea(
  ...
  function resize(el: HTMLTextAreaElement | null) {
    ...
    // window.innerHeight (viewport de layout) — com interactiveWidget: "resizes-content"
    // (ver app/layout.tsx), ela já encolhe junto com o teclado virtual, então isso
    // reflete corretamente quanto de tela ainda sobra pra caixa crescer enquanto
    // a pessoa digita, sem depender de visualViewport.height à parte.
